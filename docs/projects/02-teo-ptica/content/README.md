...
> **Карта:** [`docs/projects/01-teo-kroliki/corpus/teo/INDEX.md`](../teo/INDEX.md) · **Pipeline:** [`inventory/pticevodstvo/pipeline/`](../inventory/pticevodstvo/pipeline/)
...
Детали: `appendix/apk-100bln-integration.md`, `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` → `project.apk_100bln`.
...
| KPI | `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` |
