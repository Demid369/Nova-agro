...
> **Блок птицы:** [`docs/projects/02-teo-ptica/content/`](..) + critical **T001-P…T236-P**
...
| **241** | налоги | **rename** «Кролиководство» → «Птицеводство» | **T241-P** |
...
### `docs/projects/01-teo-kroliki/corpus/teo/` (140 файлов)
...
- `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` — KPI, vendors, risks
...
|-----------|---|-------------|
| Critical tables блок 1 | **~95%** | 9/9 draft incl. **T241-P**; T001 merge II–III |
...
# → docs/projects/02-teo-ptica/pipeline/docx/00-master-teo-pticevodstvo-draft.docx
```

Манифест: [`docs/projects/02-teo-ptica/pipeline/assembly-standalone.yaml`](../../inventory/pticevodstvo/pipeline/assembly-standalone.yaml)
