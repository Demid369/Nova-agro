...
> Источники: `docs/projects/01-teo-kroliki/finmodel/1.2-слайд Фин модель.xlsx` (Приложение 3Б), `finmodel-pticekompleks-12-mlrd.xlsx` (лист **«APK-100»**), `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` → `project.apk_100bln`.
...
| Убой / экспорт / УK | общие службы | УПК — **РФ**; **экспорт 10,2 млрд Tab#5** через блок 1 / УК |
...
| Артефакт | Путь |
|----------|------|
| Канон сценария C | `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` → `project.apk_100bln` |
| Лист «APK-100» | `finmodel-pticekompleks-12-mlrd.xlsx` |
| Финансирование блока | лист «Финансирование» того же xlsx |
| Шаблон 100 млрд | `docs/projects/01-teo-kroliki/finmodel/1.2-слайд Фин модель.xlsx` |
