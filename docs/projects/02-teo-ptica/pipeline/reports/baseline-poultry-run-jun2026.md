...
> **Выход:** `docs/projects/02-teo-ptica/pipeline/docx/1.ТЭО_МОЯ_МЕЧТА_ПТИЦА.docx`  
> **Карта картинок:** `docs/projects/02-teo-ptica/pipeline/media/image-map.json`
...
# → docs/projects/02-teo-ptica/pipeline/media/* (346 files, gitignored)
```
