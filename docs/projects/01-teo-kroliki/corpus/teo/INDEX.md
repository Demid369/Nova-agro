...
> KPI птицы: `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml`
...
| **Graph / RAG (baseline)** | `docs/projects/01-teo-kroliki/corpus/graphify-corpus/` + `graphify query …` | `graphify-out/` |
| **Править KPI / сценарий** | `docs/projects/02-teo-ptica/scenarios/poultry-teo.yaml` | — |
...
│       ├── pipeline/             ← yaml фазы 1–10, assembly, patch-rules
