...
```
docs/projects/01-teo-kroliki/inventory/
  README.md              ← вы здесь
...
Каждый DOCX содержит **ссылки на исходный ТЭО** в формате `файл:строка` (например `docs/projects/01-teo-kroliki/corpus/graphify-corpus/01-vvedenie-i-resume.md:712–810`).
...
|------|------|------------------|
| Исходный ТЭО | `docs/projects/01-teo-kroliki/corpus/teo/` | эталон для сверки RAG |
| RAG-корпус | `docs/projects/01-teo-kroliki/corpus/graphify-corpus/` | то, что индексируется |
| Сценарий | `docs/projects/01-teo-kroliki/scenarios/baseline.yaml` | структурированные KPI блока |
