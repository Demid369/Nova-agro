...
| Сертификация | **РДУМ**, при экспорте в ОАЭ — **ESMA/GSO** |
| CAPEX | **≈120–180 млн ₽** (внутри 2 600 УПК) |
| Связь с экспортом | 100% экспортного мяса — через халяль-блок (`export-plan-friendly-countries.md`) |
...
3. Приоритет экспорта **ОАЭ/Иран** → влияет на глубину халяль-автоматизации.  
