...
Полностью автоматизированное оборудование для содержания и выращивания птицы (**118 птичников/модулей**: бройлер, несушки, индейка, утка, гусь, перепёл) поставляется российской компанией **TEXHA** (г. Воронеж). Профиль: туннельная вентиляция, кормление, поение, SCADA, микроклимат. **80 бройлерных** модулей по **18 000 голов**; **6** блоков клеточного содержания несушек (**480 000** голов).

*Альтернатива (приложение / RFQ):* **Big Herdsman** (Китай) при EPC-подрядчике с адаптацией под нормы РФ и VetIS.
...
|------|------------------|--------------------|-----------------|
| Птичники бройлера (80×) | часть 2 405 | 18 000 гол/дом | **TEXHA** (РФ) |
| Клетки несушек (6×) | ↑ | 480 000 гол | **TEXHA** |
| Индюк / утка / гусь / перепёл | 1 025 | см. T02 | **TEXHA** + модульные линии |
...
| | Кролики | Птица (канон) |
|--|---------|---------------|
| Содержание | **Meneghin Srl** (IT), 69 intensive | **TEXHA** (РФ), 118 модулей |
...
```mermaid
flowchart LR
  A[ТЗ по зонам] --> B[RFQ: TEXHA + SINT poultry 6000]
...
| Этап | Срок | Действие |
|------|------|----------|
| T0 | −18 мес. | ТЗ, RFQ TEXHA + SINT poultry |
