# Индекс critical-таблиц птицеводства

> Аналог [`docs/graphify-corpus/07-docx-tables-critical.md`](../../graphify-corpus/07-docx-tables-critical.md) для блока птицы.
...
| T022-P | [`T022-investment-schedule-pticevodstvo.md`](../teo-tables/critical/T022-investment-schedule-pticevodstvo.md) | draft (**фазировка TBD**) | finmodel «CAPEX» |
