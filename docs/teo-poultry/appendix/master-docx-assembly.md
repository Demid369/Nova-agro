...
| 6 | Местоположение | T003 baseline **100k га Херсон** | **T003-P** (250k / слот 400 га) | ⚠️ кадастр null |
...
| 11 | Финансовая оценка | методология 10 лет @10% | **T007-P**, `npv-irr-derived.md` (**16 лет**) | ⚠️ политика |
