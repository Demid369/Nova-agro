...
- Corpus for full rebuild: `docs/projects/01-teo-kroliki/corpus/graphify-corpus/`
- Source docx (66 MB) is excluded — use markdown corpus instead
- After editing corpus files, run `graphify extract docs/projects/01-teo-kroliki/corpus/graphify-corpus --update` or `/graphify docs/projects/01-teo-kroliki/corpus/graphify-corpus --update` in Cursor
