...
APK_ASSEMBLY_PATH = ROOT / "docs/projects/02-teo-ptica/pipeline/assembly-apk-full.yaml"
PATCH_RULES_PATH = ROOT / "docs/projects/02-teo-ptica/pipeline/corpus-patch-rules.yaml"
